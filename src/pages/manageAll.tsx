...
const ManageAll = () => (
	...
	<div className="m-4 flex flex-col">
		<NavCard to="/managePasswords" name="Password">
			<svg
				aria-hidden="true"
				focusable="false"
				data-prefix="far"
		...
		<NavCard to="/manageSecureNotes" name="Secure Note">
			<svg
				aria-hidden="true"
				focusable="false"
				data-prefix="fad"
		...
		<NavCard to="/manageAddresses" name="Address">
			<svg
				aria-hidden="true"
				focusable="false"
				data-prefix="fal"
		...
		<NavCard to="/managePaymentMethods" name="Payment Method">
			<svg
				aria-hidden="true"
				focusable="false"
				data-prefix="far"
		...
		<NavCard to="/manageBanks" name="Bank">
			<svg
				aria-hidden="true"
				focusable="false"
				data-prefix="far"
